...
-- Volcando datos para la tabla base_de_datos_cartilla.cartilla: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla base_de_datos_cartilla.cliente: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla base_de_datos_cartilla.detalle_pedido: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla base_de_datos_cartilla.marca: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla base_de_datos_cartilla.pago: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla base_de_datos_cartilla.pedido: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla base_de_datos_cartilla.producto: ~0 rows (aproximadamente)
